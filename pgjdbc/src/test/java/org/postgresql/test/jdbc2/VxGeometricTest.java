...
public class VxGeometricTest extends VxBaseTest4 {

  public VxGeometricTest(BinaryMode binaryMode) {
  ...
  public void testPGline() throws Exception {
    ...
    final boolean roundTripToDatabase = VxTestUtil.haveMinimumServerVersion(con, ServerVersion.v9_4);
