...
public class VxTimezoneCachingTest extends VxBaseTest4 {
   ...
   */
  @Test
  public void testPreparedStatementCachedTimezoneUsage() throws SQLException, InterruptedException, ExecutionException {
    Timestamp ts = new Timestamp(2016 - 1900, 0, 31, 0, 0, 0, 0);
   ...
   */
  @Test
  public void testResultSetCachedTimezoneInstance() throws SQLException, InterruptedException, ExecutionException {
    Timestamp ts = new Timestamp(2016 - 1900, 0, 31, 0, 0, 0, 0);
    TimeZone tz = TimeZone.getDefault();
    VxStatement stmt = null;
    VxPreparedStatement pstmt = null;
   ...
   */
  @Test
  public void testResultSetCachedTimezoneUsage() throws SQLException, InterruptedException, ExecutionException {
    VxStatement stmt = null;
    VxPreparedStatement pstmt = null;
    VxResultSet rs = null;
    TimeZone tz1 = TimeZone.getTimeZone("GMT+8:00");
  ...
  private void checkTimestamp(String checkText, VxStatement stmt, Timestamp ts, TimeZone tz)
  ...
  public void setUp() throws Exception {
    ...
    VxTestUtil.createTable(con, "testtz", "col1 INTEGER, col2 TIMESTAMP");
  }

  // Tear down the fixture for this test case.
  public void tearDown() throws SQLException {
    try {
      VxTestUtil.dropTable(con, "testtz");
