...
public class VxPGPropertyTest {
  ...
  public void testIsPresentWithParseURLResult() throws Exception {
    ...
    Properties parsedProperties = VxDriver.parseURL(TestUtil.getURL(), givenProperties);
    ...
    parsedProperties = VxDriver.parseURL(TestUtil.getURL(), givenProperties);
    ...
    parsedProperties = VxDriver.parseURL(TestUtil.getURL() + "&ssl=true", null);
    assertTrue("SSL property should be present", PGProperty.SSL.isPresent(parsedProperties));
  }
  ...
  public void testEncodedUrlValues() {
    ...
    Properties parsed = VxDriver.parseURL(url, new Properties());
