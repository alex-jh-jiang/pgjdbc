 ...
 */
public class VxDatabaseEncodingTest {
  ...
  public void setUp() throws Exception {
    ...
    VxTestUtil.createTable(con, "testdbencoding",
  ...
  public void tearDown() throws Exception {
    ...
    VxTestUtil.dropTable(con, "testdbencoding");
  ...
  public void testEncoding() throws Exception {
    ...
    VxResultSet rs = stmt.executeQuery("SELECT getdatabaseencoding()").get();
    assertTrue(rs.next().get());

    String dbEncoding = rs.getString(1).get();
    ...
    VxPreparedStatement insert = con.prepareStatement(
    ...
    rs = stmt.executeQuery(
        "SELECT unicode_ordinal, unicode_string FROM testdbencoding ORDER BY unicode_ordinal").get();
    for (int i = 1; i < 0xd800; i += STEP) {
      assertTrue(rs.next().get());
      assertEquals(i, (Object)rs.getInt(1).get());
