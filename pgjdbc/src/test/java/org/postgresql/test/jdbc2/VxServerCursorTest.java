 ...
 */
public class VxServerCursorTest extends VxBaseTest4 {

  @Override
  public void setUp() throws Exception {
    super.setUp();
    VxTestUtil.createTable(con, "test_fetch", "value integer,data bytea");
  ...
  protected void createRows(int count) throws Exception {
    VxPreparedStatement stmt = con.prepareStatement("insert into test_fetch(value,data) values(?,?)");
  ...
  public void testBasicFetch() throws Exception {
    ...
    while (rs.next().get()) {
      ...
      assertEquals("query value error", 1, (Object)rs.getInt(1).get());
